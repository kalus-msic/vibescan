...
NARRATIVE_SECTIONS = [
    ...
    },
    {
        ...
        "blocks": [
            ...
            {"type": "callout", "variant": "warning", "html": "Pro útočníka nebo konkurenci je tahle informace zlatá: pokud zjistí, že byl při vývoji použit nástroj <strong>bez opt-outu z trénování</strong>, ví, kde hledat uniklé informace o klientovi."},

            {"type": "h3", "text": "Co dělají AI nástroje s tvými prompty"},
            {"type": "p", "html": "Většina AI služeb v consumer režimu (osobní účet, free/plus tier) <strong>defaultně trénuje na uživatelských vstupech</strong>. Opt-out je obvykle možný, ale musíš ho aktivně zapnout. Business/Enterprise tiery typicky netrénují by default a nabízejí DPA (Data Processing Agreement)."},

            {"type": "h3", "text": "Chatboti a AI asistenti — trénují na tvých datech?"},
            {"type": "table",
             "headers": ["Nástroj", "Trénuje by default?", "Jak vypnout / poznámka"],
             "rows": [
            ...
            {"type": "callout", "variant": "info", "html": "<strong>Pravidlo:</strong> Pokud do AI promptu zadáváš cokoliv obsahujícího osobní data klienta/uživatele (jména, e-maily, telefony, IČO, smlouvy, interní dokumenty), <strong>musíš</strong> používat účet s vypnutým trénováním <em>a</em> ideálně s DPA. Osobní free/plus účet = consumer terms = data klienta odchází do trénovacího datasetu."},

            {"type": "h3", "text": "DPA s AI providery a hostingem"},
            {"type": "p", "html": "DPA (Data Processing Agreement) je smlouva podle GDPR čl. 28 mezi tebou (správce) a providerem (zpracovatel). Bez DPA <strong>nesmíš provideru předávat osobní data klienta</strong> v rámci své činnosti. Consumer účty DPA neposkytují — je to business feature."},
            {"type": "table",
             "headers": ["Provider", "Poskytuje DPA?", "Poznámka"],
             "rows": [
            ...
            {"type": "h3", "text": "Lokální alternativa: Ollama"},
            {"type": "p", "html": "Ollama je výjimka — běží lokálně na tvém počítači, takže data nikdy neopouští systém. Žádné DPA nepotřebuje, žádný opt-out, žádné trénování."},
            {"type": "p", "html": "Claude Code lze přesměrovat na lokální Ollama: <code>ANTHROPIC_BASE_URL=http://localhost:11434</code> (funkční od Ollama v0.14, leden 2026). Kód pak zůstane lokální, ale výkon je výrazně nižší (7B–13B modely vs. Claude Sonnet/Opus)."},
            {"type": "p", "html": "<strong>Praktické omezení:</strong> Claude Code posílá ~18 K tokenů systémový prompt — výchozí kontext Ollama (4 K) nestačí. Nastav minimálně 64 K kontext přes Modelfile. Některé pokročilé funkce (prompt caching, count_tokens) nejsou podporovány."},

            {"type": "h3", "text": "Praktický checklist před každým AI promptem"},
            {"type": "ol", "items": [
                "Obsahuje prompt osobní data (klienta, uživatele, zaměstnance)?",
                "Pokud ano, používám účet s vypnutým trénováním <strong>a</strong> s DPA?",
                "Pokud ne, mohu data <strong>anonymizovat</strong> (nahradit reálná jména/kontakty placeholderem)?",
                "Pokud anonymizovat nelze, je nutné AI vůbec použít? (Alternativa: lokální Ollama nebo manuálně.)",
            ]},
            {"type": "callout", "variant": "danger", "html": "<strong>Co dělat při úniku:</strong> Pokud jsi omylem poslal osobní data do nástroje bez opt-outu, do trénovacích dat to už pravděpodobně šlo. Nahlas to klientovi (transparentnost = klíčový princip GDPR), požádej providera o smazání (málokdy úspěšné), zhodnoť rozsah (DPIA) a pokud jde o citlivá data, zvaž ohlášení ÚOOÚ do 72 hodin (GDPR čl. 33)."},

            {"type": "sources", "items": [
                "OpenAI Privacy & Business terms: <a href='https://openai.com/policies' rel='noopener' class='underline'>openai.com/policies</a>",
                "Anthropic Privacy: <a href='https://www.anthropic.com/legal/privacy' rel='noopener' class='underline'>anthropic.com/legal/privacy</a>",
                "Google AI training settings: <a href='https://myactivity.google.com/product/gemini' rel='noopener' class='underline'>myactivity.google.com/product/gemini</a>",
                "GitHub Copilot data privacy: <a href='https://docs.github.com/en/copilot/responsible-use-of-github-copilot-features' rel='noopener' class='underline'>docs.github.com</a>",
                "GDPR čl. 28 (DPA): <a href='https://gdpr-info.eu/art-28-gdpr/' rel='noopener' class='underline'>gdpr-info.eu/art-28</a>",
                "GDPR čl. 33 (ohlášení úniku): <a href='https://gdpr-info.eu/art-33-gdpr/' rel='noopener' class='underline'>gdpr-info.eu/art-33</a>",
            ]},
        ],
    },
    {
